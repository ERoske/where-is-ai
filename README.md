...
- **Year-over-year percentages lie when the prior-year baseline was suppressed.** BLS reports null or a floor near 80 workers for metros under its confidentiality threshold. When the May 2024 number was suppressed and the May 2025 number is real, the percent-change column in `data/usa_yoy_findings.md` shows inflated growth that is a baseline artifact, not actual hiring. Salt Lake City (80 to 2,970, listed as +3,612%) and Warner Robins (80 to 760, listed as +850%) are clear examples this cycle. The trustworthy YoY percentages are the rows where both years cleared the suppression floor: New York at +18.9%, Chicago at +38.9%, Seattle at +22.3%, Washington DC at +8.6%. The absolute delta column is still meaningful in all cases because the current-year number is real.
